  ...
  eos_temp = input(2)
  call eos_helmholtz
  eos_pres_entr(1) = eos_pres
  eos_pres_entr(2) = eos_entr
  ...
  eos_temp = input(2)
  call eos_helmholtz
  eos_pres_entr_zero(1) = (eos_pres - eos_target_pres)/eos_target_pres
  eos_pres_entr_zero(2) = (eos_entr - eos_target_entr)/eos_target_entr
